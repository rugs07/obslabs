...
export default function ShardButton({
    ...
    const sizeClasses = {
        sm: 'px-8 py-4 text-sm tracking-widest gap-3',
        md: 'px-12 py-5 text-base tracking-widest gap-4',
        lg: 'px-16 py-7 text-xl tracking-[0.2em] gap-5',
        xl: 'px-24 py-10 text-2xl tracking-[0.25em] gap-6',
    };
    ...
    const variantClasses = {
        ...
        outline: `
            ...
            rounded-full
            backdrop-blur-sm
            hover:border-white/30 hover:text-white hover:bg-white/[0.02]
            hover:scale-[1.02]
            active:scale-[0.98]
        `,
    };
